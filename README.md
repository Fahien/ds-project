  ...
  <p>L'<strong>altezza</strong> di un nodo è zero se è una foglia; altrimenti uno più l'altezza massima tra i figli del nodo. Il <strong>sottoalbero</strong> di T con radice al nodo v è l'albero che consiste di tutti i discendenti di v in T (incluso v), si scrive T<sub>v</sub>.</p>
  ...
  <p>Un sottoalbero con radice che è figlia sinistra o destra di un nodo v è chiamato rispettivamente <strong>sottoalbero sinistro</strong> o <strong>sottoalbero destro</strong> di v. Un albero binario è <strong>proprio</strong> se ogni nodo ha o zero o due figli.</p>
 ...
 <h2>Hash Table</h2>
  ...
  <p>Per la rimozione di un insieme dalla partizione, invece di cercare la posizione di tale insieme, è utile inserire nella classe che implementa <i>Set</i> una variabile che tenga traccia di questa posizione.</p>
